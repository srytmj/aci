...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        DB::table('termin_proyek')->insert([
            ['id_proyek'=> 1, 'id_tipe_termin'=> 1, 'nominal'=> 1000000, 'keterangan'=> 'Termin Proyek A'],
            ['id_proyek'=> 2, 'id_tipe_termin'=> 2, 'nominal'=> 2000000, 'keterangan'=> 'Termin Proyek B'],
        ]);
        ...
        DB::table('kas_masuk')->insert([
            ['no_form'=> 'KM-001/2026', 'tanggal_masuk'=> '2026-01-01', 'id_kategori_masuk'=> 1, 'id_proyek'=> 1, 'id_metode_bayar'=> 1, 'id_termin_proyek'=> 1, 'nominal'=> 1000000, 'keterangan'=> 'Kas masuk Proyek A', 'upload_bukti'=> 'km-001-2026.jpg'],
            ['no_form'=> 'KM-002/2026', 'tanggal_masuk'=> '2026-01-02', 'id_kategori_masuk'=> 2, 'id_proyek'=> 2, 'id_metode_bayar'=> 2, 'id_termin_proyek'=> 2, 'nominal'=> 2000000, 'keterangan'=> 'Kas masuk Proyek B', 'upload_bukti'=> 'km-002-2026.jpg'],
        ]);
        ...
        DB::table('kas_keluar')->insert([
            ['no_form'=> 'KK-001/2026', 'tanggal_keluar'=> '2026-01-01', 'id_kategori_keluar'=> 1, 'id_proyek'=> 1, 'id_vendor'=> 1, 'id_metode_bayar'=> 1, 'nominal'=> 1000000, 'keterangan'=> 'Kas keluar Proyek A', 'upload_bukti'=> 'kk-001-2026.jpg'],
            ['no_form'=> 'KK-002/2026', 'tanggal_keluar'=> '2026-01-02', 'id_kategori_keluar'=> 2, 'id_proyek'=> 2, 'id_vendor'=> 2, 'id_metode_bayar'=> 2, 'nominal'=> 2000000, 'keterangan'=> 'Kas keluar Proyek B', 'upload_bukti'=> 'kk-002-2026.jpg'],
        ]);
