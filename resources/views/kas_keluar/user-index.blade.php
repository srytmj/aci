<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div
                ...
                <div class="p-6 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
                    <div>
                        <h3 class="text-lg font-bold text-rose-600">Data Pengeluaran Kas</h3>
                        <p class="text-xs text-gray-500 font-medium">Monitoring arus kas keluar untuk operasional & proyek</p>
                    </div>
                </div>

                <div class="p-6">
                    <table id="kasKeluarUserTable" class="w-full cell-border stripe hover">
                        <thead>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="flex justify-center">
                                            <a href="{{ route('kas-keluar.show', $k->id_kas_keluar) }}"
                                                class="p-2 text-gray-400 hover:bg-rose-50 hover:text-rose-600 rounded-lg transition"
                                                title="Lihat Rincian">
    ...
    <script>
        $(document).ready(function() {
            var table = $('#kasKeluarUserTable').DataTable({
                responsive: true,
                ...
                language: { search: "_INPUT_", searchPlaceholder: "Cari data pengeluaran..." }
            });
        ...
        // Tetap pasang SweetAlert2 untuk error sistem
