        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div
                ...
                <div class="p-6 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
                    <div>
                        <h3 class="text-lg font-bold text-600">Arus Kas Keluar</h3>
                        <p class="text-xs text-gray-500 font-medium">Monitoring pengeluaran operasional, vendor, dan
                            proyek</p>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="flex justify-center gap-2">
                                            ...
                                            <form id="delete-form-{{ $k->id_kas_keluar }}"
                                                action="{{ route('kas-keluar.destroy', $k->id_kas_keluar) }}"
                        ...
                        <tfoot class="bg-gray-50">
                            <tr>
                                ...
                                <th><input type="text" placeholder="Tanggal"
                                        class="w-full text-[10px] rounded border-gray-200 p-1"></th>
                                <th><input type="text" placeholder="Kategori"
                                        class="w-full text-[10px] rounded border-gray-200 p-1"></th>
                                <th><input type="text" placeholder="Proyek/Vendor"
                                        class="w-full text-[10px] rounded border-gray-200 p-1"></th>
