<x-app-layout>
                ...
                <div
                    ...
                    <div>
                        <h3 class="font-bold text-indigo-600 dark:text-indigo-400 uppercase tracking-widest text-sm">
                            Buku Jurnal Umum</h3>
                        <p class="text-[10px] text-gray-400 dark:text-gray-500 uppercase tracking-tighter">Periode:
                            {{ date('F', mktime(0, 0, 0, $bulan, 1)) }} {{ $tahun }}</p>
                    </div>
                    <div id="exportButtons" class="flex gap-2"></div>
                </div>

                <div class="p-6 overflow-x-auto">
                    <table id="jurnalTable" class="w-full">
                        <thead>
            ...
            {{ str_contains($j->no_ref, 'KM')
                ...
                : 'bg-rose-50 text-rose-600 border-rose-100 dark:bg-rose-500/10 dark:text-rose-400 dark:border-rose-500/20' }}">
                                    ...
                                    <td class="p-4 text-right font-bold text-gray-700 dark:text-gray-300">
                                        {{ $j->posisi_dr_cr == 'dr' ? number_format($j->nominal, 0, ',', '.') : '-' }}
                                    </td>
                                    <td class="p-4 text-right font-bold text-gray-700 dark:text-gray-300">
                                        {{ $j->posisi_dr_cr == 'cr' ? number_format($j->nominal, 0, ',', '.') : '-' }}
                                    </td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="6" class="p-10 text-center text-gray-400 dark:text-gray-600 italic">
                                        Data jurnal belum tersedia.</td>
                                </tr>
                            @endforelse
                        </tbody>
                        <tfoot
                            ...
                            <tr>
                                <td class="p-4 text-left uppercase tracking-widest text-[10px]">TOTAL PERIODE</td>
                                <td class="p-4"></td>
                                <td class="p-4"></td>
                                <td class="p-4"></td>
    ...
    <style>
        /* Menghilangkan border default DataTables yang jelek */
